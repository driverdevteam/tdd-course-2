...
TEST(BankOCR, CalculateDisplayChecksumOnes)
{
    size_t checksum = CalculateDisplayChecksum("111111111");
    EXPECT_EQ(45, checksum);
}

TEST(BankOCR, CalculateDisplayChecksumZerosAndOne)
{
